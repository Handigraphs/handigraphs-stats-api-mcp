...
try {
  ...
  for (const required of ["CHANGELOG.md", "LICENSE", "README.md", "SECURITY.md", "dist/index.js", "package.json", "runtime/configure-macos.mjs", "runtime/configure-windows.ps1", "scripts/audit-live-sandbox.mjs"]) assert.ok(files.includes(required), `missing ${required}`);
